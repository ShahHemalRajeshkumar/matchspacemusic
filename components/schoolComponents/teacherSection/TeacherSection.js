...
const TeacherDetailSidebar = dynamic(() => import('./teacherDetailSidebar'), { ssr: false });
const TeacherSectionSidebar = dynamic(() => import('./teacherSectionSidebar'), { ssr: false });
const TeacherProfile = dynamic(() => import('./TeacherProfile'), { ssr: false });
