...
dynamic(() => import('mapbox-gl/dist/mapbox-gl.css'), { ssr: false });

const OtherLocationSection = dynamic(() => import('./OtherLocationSection'));
const InstrumentRelatedLocation = dynamic(() => import('./instrumentRelatedLocation'));
